...
export default function HelpPage() {
  ...
  const faqCategories = [
    {
      id: 1,
      name: language === 'kg' ? 'Заказ жасоо' : 'Оформление заказа',
      nameKg: 'Заказ жасоо',
      ...
      faqs: [
        {
          id: 1,
          question: language === 'kg' ? 'Заказды кантип жасоого болот?' : 'Как оформить заказ?',
          answer: language === 'kg' 
        ...
        {
          id: 2,
          question: language === 'kg' ? 'Заказды кантип өзгөртүүгө болот?' : 'Как изменить заказ?',
          answer: language === 'kg' 
        ...
        {
          id: 3,
          question: language === 'kg' ? 'Заказды кантип жокко чыгарууга болот?' : 'Как отменить заказ?',
          answer: language === 'kg' 
    ...
    },
    {
      ...
      faqs: [
        {
          id: 4,
          question: language === 'kg' ? 'Кандай төлөм ыкмалары бар?' : 'Какие способы оплаты доступны?',
          answer: language === 'kg' 
        ...
        {
          id: 5,
          question: language === 'kg' ? 'Төлөм коопсузбу?' : 'Безопасна ли оплата?',
          answer: language === 'kg' 
    ...
    {
      id: 3,
      name: language === 'kg' ? 'Жеткирүү' : 'Доставка',
      nameKg: 'Жеткирүү',
      nameRu: 'Доставка',
      icon: '🚚',
      faqs: [
        {
          id: 6,
          question: language === 'kg' ? 'Жеткирүү канчага созулат?' : 'Сколько длится доставка?',
          answer: language === 'kg' 
        ...
        {
          id: 7,
          question: language === 'kg' ? 'Жеткирүү акысы канча?' : 'Сколько стоит доставка?',
          answer: language === 'kg' 
            ? 'Бишкек шаарында 200 с., аймактарда 500 с.. 5000 с.дан жогору заказдарда акысыз.'
            : 'В городе Бишкек 200 с., в регионах 500 с.. Бесплатно при заказе от 5000 с..'
        }
      ]
    },
    {
      id: 4,
      name: language === 'kg' ? 'Кайтаруу' : 'Возврат',
      nameKg: 'Кайтаруу',
      nameRu: 'Возврат',
      icon: '↩️',
      faqs: [
        {
          id: 8,
          question: language === 'kg' ? 'Товарды кантип кайтарууга болот?' : 'Как вернуть товар?',
          answer: language === 'kg' 
        ...
        {
          id: 9,
          question: language === 'kg' ? 'Кайтаруу акысын кантип алууга болот?' : 'Как получить деньги за возврат?',
          answer: language === 'kg' 
  ...
  const contactMethods = [
    {
      id: 1,
      name: language === 'kg' ? 'Телефон' : 'Телефон',
      nameKg: 'Телефон',
      nameRu: 'Телефон',
      icon: Phone,
      value: '+996 555 123 456',
      description: language === 'kg' ? 'Дайыма жеткиликтүү' : 'Всегда доступен',
      color: 'bg-blue-500'
    },
    {
      id: 2,
      name: language === 'kg' ? 'Email' : 'Email',
      nameKg: 'Email',
      nameRu: 'Email',
      icon: Mail,
      value: 'help@storeclient.kg',
      description: language === 'kg' ? '24 саат ичинде жооп' : 'Ответ в течение 24 часов',
      color: 'bg-green-500'
    },
    {
      id: 3,
      name: language === 'kg' ? 'Чат' : 'Чат',
      nameKg: 'Чат',
      nameRu: 'Чат',
      icon: MessageCircle,
      value: language === 'kg' ? 'Онлайн чат' : 'Онлайн чат',
      description: language === 'kg' ? 'Дайыма жеткиликтүү' : 'Всегда доступен',
      color: 'bg-purple-500'
    }
  ]
  ...
  const workingHours = [
    {
      day: language === 'kg' ? 'Дүйшөмбү - Жума' : 'Понедельник - Пятница',
      time: '09:00 - 18:00'
    },
    {
      day: language === 'kg' ? 'Ишемби' : 'Суббота',
      time: '10:00 - 16:00'
    },
    {
      day: language === 'kg' ? 'Жекшемби' : 'Воскресенье',
      time: language === 'kg' ? 'Дем алыш' : 'Выходной'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">
            {language === 'kg' ? 'Сизге көмөк керекпи?' : 'Нужна помощь?'}
          </h2>
        ...
        <div className="mb-12">
          <div className="max-w-2xl mx-auto relative">
            ...
            <input
              type="text"
              placeholder={language === 'kg' ? 'Сорууларыңызды издөө...' : 'Поиск вопросов...'}
              value={searchQuery}
        ...
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">
            {language === 'kg' ? 'Көп берилүүчү суроолор' : 'Часто задаваемые вопросы'}
          </h3>
              ...
              {faqCategories.map((category) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    {category.faqs.length} {language === 'kg' ? 'суроо' : 'вопросов'}
                  </p>
                  <div className="flex items-center text-orange-500 text-sm font-medium">
                    <span>{language === 'kg' ? 'Көрүү' : 'Смотреть'}</span>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-12">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h3 className="text-2xl font-bold text-gray-900">
              {language === 'kg' ? 'Иш убактысы' : 'Время работы'}
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-gradient-to-r from-orange-500 to-pink-500 rounded-lg p-8 text-white">
            <h3 className="text-2xl font-bold mb-4">
              {language === 'kg' ? 'Тез көмөк' : 'Быстрая помощь'}
            </h3>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg p-8 text-white">
            ...
            <button className="bg-white text-blue-500 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              {language === 'kg' ? 'Текшерүү' : 'Проверить'}
            </button>
          </div>
        </div>
        ...
        <div className="text-center bg-gray-100 rounded-lg p-8">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
            {language === 'kg' ? 'Дагы көмөк керекпи?' : 'Все еще нужна помощь?'}
          </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border border-orange-500 text-orange-500 px-8 py-3 rounded-lg font-semibold hover:bg-orange-50 transition-colors">
              {language === 'kg' ? 'Чат ачуу' : 'Открыть чат'}
            </button>
          </div>
        </div>
      </div>
