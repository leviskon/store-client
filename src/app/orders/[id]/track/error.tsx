...
import { Home, RefreshCw, Truck } from 'lucide-react'
...
export default function TrackOrderError({ error, reset }: ErrorProps) {
  const params = useParams()
  const orderId = params.id

  useEffect(() => {
    console.error('Track order page error:', error)
  }, [error])
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-8">
            Произошла ошибка при загрузке информации об отслеживании заказа.
            {orderId && (
